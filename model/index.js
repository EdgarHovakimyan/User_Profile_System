...
const sequelize = new Sequelize('dnode11', 'root', '', {
  host: 'localhost',
  port: 3306,
  dialect: 'mysql',
});
...
Person.hasMany(Order, { foreignKey: 'personId', });
Person.hasMany(Wishlist, { foreignKey: 'personId' });
